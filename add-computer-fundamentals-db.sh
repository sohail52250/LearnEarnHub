...
echo "Creating Computer Fundamentals database seed..."

mkdir -p database

cat > database/computer-fundamentals-seed.sql <<'SQL'
...
echo "SQL created:"
cat database/computer-fundamentals-seed.sql

git add database/computer-fundamentals-seed.sql

git commit -m "Add Computer Fundamentals database course seed" || true
